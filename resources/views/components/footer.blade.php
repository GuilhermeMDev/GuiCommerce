<footer class="text-gray-600">
    <div class="border-t border-gray-200">
        <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
            <form action="{{ route('products.search') }}" method="get" class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
                <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
                    <label for="footer-field" class="leading-7 text-sm text-gray-600">Busque seus Produtos</label>
                    <input type="text" id="footer-field" name="search"

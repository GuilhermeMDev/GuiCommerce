...
@section('content')
  ...
  <section class="text-gray-600 body-font pt-28 pb-24">
        <div class="container px-5 py-24 mx-auto">
            <div class="xl:w-2/2 lg:w-3/4 w-full h-full mx-auto text-center">
                ...
                <p class="leading-relaxed text-lg">GuiCommerce é uma base para um Ecommerce, aqui tentei trazer os
                    principais conceitos e ferramentas que teriamos em um ecommerce real, a fins de tonar a experiência
                    de desenvolvimento o mais próximo do real, aqui utilizei framework como Laravel 9, VueJs, linguagens

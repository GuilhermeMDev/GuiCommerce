       ...
       <div class="bg-gray-100">
           <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
               <p class="text-gray-500 text-sm text-center sm:text-left">© 2022 Guilherme Dev —
                   <a href="https://github.com/GuilhermeMDev" class="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer"> @GitHub</a>
               </p>
               <span class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">I’m slowly becoming the person I should have been a long time ago. </span>
           </div>
       </div>
   </footer>
@endsection
